<template>
    <div>
        ...
        >
            <h4>
                欢迎访问由“觅漾工作室”（以下简称为“我方”）出品的“中南林业科技大学2020高考志愿填报分析系统” （以下简称为“此系统”）。<span style="color:#409EFF">建议使用PC端进行访问。</span> 请您仔细阅读以下条款，如果您对本协议的任何条款表示异议，您可以选择不进入此系统。当您进入后，无论是否进行志愿分析，均意味着您完全接受本协议项下的全部条款。
            </h4><br>
            <h3>一、定义</h3>
            <div>觅漾工作室： “觅漾工作室”前身为“林科大小可爱工作室”。是由中南林业科技大学学生自建的创新创业校园工作室。团队旨在丰富同学们的校园文化生活，提供便利的校园生活服务。同时，是大学生提升自我展现才能、开阔眼界的舞台。</div>
            <div>此系统 : 由“觅漾工作室” 技术部开发，旨在为高考后志愿填报的考生提供录取概率的参考。由于各省份高考政策的不同，以及新高考的实行，部分省份此前录取信息参考价值不大，故此系统仅支持 19 个省份的志愿分析。</div>
            <h3>二、免责声明</h3>
            <div>1、 本系统完全由我方开发，团队的学长学姐只是想为各位考生提供一些帮助。<span style="color:#409EFF">与中南林业科技大学招生办及任何其他组织无关！</span></div>
            ...
            <h3>四、其他</h3>
            <div>1、 本协议解释权及修订权归我方所有。</div>
            <div>2、 如果不同意我方对本协议相关条款所做的修改，您有权并应当停止使用此系统。如果您继续使用此系统，则视为您接受我方对本协议相关条款所做的修改。</div>
